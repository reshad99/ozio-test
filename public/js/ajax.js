...
window.ajaxPost = /*#__PURE__*/function () {
  var _ajaxPost = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, data) {
    var method,
      csrfToken,
      response,
      responseData,
  ...
  function ajaxPost(_x, _x2) {
    return _ajaxPost.apply(this, arguments);
  }
  return ajaxPost;
}();
window.ajaxFetch = /*#__PURE__*/function () {
  var _ajaxFetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(route) {
    var response, data;
  ...
  function ajaxFetch(_x3) {
    return _ajaxFetch.apply(this, arguments);
  }
  return ajaxFetch;
}();
...
window.generalPostRequest = function generalPostRequest(url, formData) {
