...
<!-- Mirrored from themesbrand.com/skote/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Apr 2023 08:15:17 GMT -->
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{ route('admin.login') }}" id="loginForm"
                                    method="POST">
            ...
            $(document).on('submit', '#loginForm', function(e) {
                ...
                ajaxPost(route, formData).then(function(data) {
                    if (data.status == 'success')
                        window.location.replace('/gopanel/dashboard')
                }).catch(function(e) {
                    fireSwal(e)
